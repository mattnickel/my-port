    ...
    return (
      ...
      <div className="container">
        ...
        <section>
          ...
          <p className={["offset-by-three", "column", "about-message"].join(' ')}>Want to hire me? Send me an email.
            <a target="_top" href="mailto:2nickels@gmail.com?subject=Just saw your portfolio online" className="underline">Click Here</a>
          </p>
        </section>
